...
build-rescue/system-routed.ncd: build-rescue/system.ncd
	cd build-rescue && par $(FILTER) -ol high -w system.ncd system-routed.ncd
...
$(BUILDDIR)/system-routed.xdl: $(BUILDDIR)/system-routed.ncd
	cd $(BUILDDIR) && xdl $(FILTER) -ncd2xdl system-routed.ncd system-routed.xdl
...
$(BUILDDIR)/system0.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 1 -w system.ngd -o system0.ncd
$(BUILDDIR)/system1.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 20 -w system.ngd -o system1.ncd
$(BUILDDIR)/system2.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 40 -w system.ngd -o system2.ncd
$(BUILDDIR)/system3.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 60 -w system.ngd -o system3.ncd
$(BUILDDIR)/system4.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 80 -w system.ngd -o system4.ncd
$(BUILDDIR)/system5.ncd: $(BUILDDIR)/system.ngd
	cd $(BUILDDIR) && map $(FILTER) -ol high -t 99 -w system.ngd -o system5.ncd

$(BUILDDIR)/system-routed0.ncd: $(BUILDDIR)/system0.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system0.ncd system-routed0.ncd > par0
$(BUILDDIR)/system-routed1.ncd: $(BUILDDIR)/system1.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system1.ncd system-routed1.ncd > par1
$(BUILDDIR)/system-routed2.ncd: $(BUILDDIR)/system2.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system2.ncd system-routed2.ncd > par2
$(BUILDDIR)/system-routed3.ncd: $(BUILDDIR)/system3.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system3.ncd system-routed3.ncd > par3
$(BUILDDIR)/system-routed4.ncd: $(BUILDDIR)/system4.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system4.ncd system-routed4.ncd > par4
$(BUILDDIR)/system-routed5.ncd: $(BUILDDIR)/system5.ncd
	cd $(BUILDDIR) && par $(FILTER) -ol high -w system5.ncd system-routed5.ncd > par5
